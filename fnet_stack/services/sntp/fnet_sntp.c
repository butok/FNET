...
fnet_return_t fnet_sntp_init( struct fnet_sntp_params *params )
{
    ...
    fnet_sntp_if.service_descriptor = fnet_poll_service_register(fnet_sntp_poll, (void *) &fnet_sntp_if);
...
void fnet_sntp_release( void )
{
    if(fnet_sntp_if.state != FNET_SNTP_STATE_DISABLED)
    {
        ...
        fnet_poll_service_unregister( fnet_sntp_if.service_descriptor );
