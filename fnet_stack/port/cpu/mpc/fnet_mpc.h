...
#include "fnet.h"
    ...
    *********************************************************************/
        ...
        #define	FNET_MPC_MC_MCTL					(*(fnet_vuint32_t*)(void*)(0xFFFB8004UL)) /* MC_ME module */
    #else
    ...
    *********************************************************************/
    ...
    #if FNET_CFG_CPU_MPC5744P || FNET_CFG_CPU_S32R274
        #define FNET_FEC0_BASE_ADDR                 ((fnet_vuint32_t*)(void*)(0xFC0B0000UL)) /* ENET module */
    #else
    ...
    *********************************************************************/
    ...
    /* Register read/write macros */
    #if FNET_CFG_CPU_MPC5744P || FNET_CFG_CPU_S32R274
        #define FNET_MPC_INTC_BASE_ADDR     (0xFC040000UL) /* INTC_0 module */
    #else
