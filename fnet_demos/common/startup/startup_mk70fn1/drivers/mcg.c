...
int pll_init(unsigned char init_osc, unsigned char osc_select, int crystal_val, unsigned char hgo_val, unsigned char erefs_val, unsigned char pll_select, signed char prdiv_val, signed char vdiv_val, unsigned char mcgout_select)
{
    ...
    if (erefs_val)
    {
        if ((crystal_val < 8000000) || (crystal_val > 32000000))
        {
    ...
    if ((prdiv_val < 1) || (prdiv_val > 8))
    {
        return 0x41;
    }
    if ((vdiv_val < 16) || (vdiv_val > 47))
    {
        return 0x42;
    }
    ...
    if ((ref_freq < 8000000) || (ref_freq > 16000000))
    {
        return 0x43;
    }
    ...
    if ((pll_freq < 180000000) || (pll_freq > 360000000))
    {
        return 0x45;
    }
...
int fbe_pbe(unsigned char osc_select, int crystal_val, unsigned char pll_select, signed char prdiv_val, signed char vdiv_val)
{
    ...
    // Check PLL reference clock frequency is within spec.
    if (((crystal_val / prdiv_val) < 8000000) || ((crystal_val / prdiv_val) > 32000000))
    {
        return 0x43;
    }
...
int fei_fbe(int crystal_val, unsigned char hgo_val, unsigned char erefs_val)
{
    ...
    if (erefs_val)
    {
        if ((crystal_val < 30000) ||
            ...
            (crystal_val > 32000000))
        {
            return 0x22;   // return error if one of the available crystal options is not available
        }
    }
...
int fbe_fbi(int irc_freq, unsigned char irc_select)
{
    ...
    if (!(irc_select))
    {
        if ((irc_freq < 31250) || (irc_freq > 39063))
        {
            return 0x31;
        }
    }
    ...
    {
        if ((irc_freq < 3000000) || (irc_freq > 5000000))
        {
            return 0x32;   // Fast IRC freq
        }
    }
    ...
    if (MCG_C4 & MCG_C4_DMX32_MASK) // if DMX32 set
    {
        switch ((MCG_C4 & MCG_C4_DRST_DRS_MASK) >> MCG_C4_DRST_DRS_SHIFT) // determine multiplier based on DRS
        {
            case 0:
                ...
                if (fll_freq_hz < 20000000)
                {
                    return 0x33;
                }
                else if (fll_freq_hz > 25000000)
                {
                    return 0x34;
                }
                break;
            case 1:
                ...
                if (fll_freq_hz < 40000000)
                {
                    return 0x35;
                }
                else if (fll_freq_hz > 50000000)
                {
                    return 0x36;
                }
                break;
            case 2:
                ...
                if (fll_freq_hz < 60000000)
                {
                    return 0x37;
                }
                else if (fll_freq_hz > 75000000)
                {
                    return 0x38;
                }
                break;
            case 3:
                ...
                if (fll_freq_hz < 80000000)
                {
                    return 0x39;
                }
                else if (fll_freq_hz > 100000000)
                {
                    return 0x3A;
                }
                break;
