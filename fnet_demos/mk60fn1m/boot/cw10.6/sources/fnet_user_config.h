...
/*****************************************************************************
*  TWR-K60F120, TWT-SER uses the default port number 5.
******************************************************************************/
#define FNET_CFG_CPU_SERIAL_PORT_DEFAULT    (5) 

#warning "The K60 bootloader with CW10.x does not work properly in go mode/command. You can use it with IAR compiler, so far."
