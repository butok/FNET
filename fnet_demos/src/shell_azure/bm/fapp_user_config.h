...
#define FAPP_CFG_NAME                   "FNET Shell Application (Azure)"
...
#define FAPP_CFG_LINK_CONNECT_SCRIPT      "dhcpc autoip; mdns; llmnr; sntp"
#define FAPP_CFG_LINK_DISCONNECT_SCRIPT   "mdns release; llmnr release; dhcpc release; autoip release"

/* SNTP server address */
#define FAPP_CFG_SNTP_CMD_SERVER_NAME   "89.221.210.188"    /* You may try "pool.ntp.org"
                                                              Confirmed addresses:  "89.221.210.188"; 
                                                                                    "37.187.104.44"; 
                                                                                    "77.78.107.252";
                                                                                    "147.251.48.140" */


#if 0 /* You must set your own Azure Device connection string. */
    /* Device connection string containing Hostname, Device Id & Device Key */
    #define FAPP_CFG_AZURE_CMD_DEVICE_CONNECTION_STRING "HostName=<host_name>;DeviceId=<device_id>;SharedAccessKey=<device_key>" 
#endif
