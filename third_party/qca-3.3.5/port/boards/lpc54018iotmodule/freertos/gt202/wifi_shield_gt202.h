...
#define WIFISHIELD_WLAN_PINT_CONNECT (kINPUTMUX_GpioPort1Pin0ToPintsel)
...
#define WIFISHIELD_SPI_CLK_CONNECT (kFRO12M_to_FLEXCOMM8)
#define WIFISHIELD_SPI_IP_RESET (kFC8_RST_SHIFT_RSTn)
#define WIFISHIELD_SPI_BAUDRATE (8000000)
#define WIFISHIELD_SPI_THRESHOLD (8)
#define WIFISHIELD_SPI_CLK kCLOCK_Flexcomm8

/* EDMA settings */
#define WIFISHIELD_DMA (DMA0)
#define WIFISHIELD_DMA_RX_CHNL (20)
#define WIFISHIELD_DMA_TX_CHNL (21)
